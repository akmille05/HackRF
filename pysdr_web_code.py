...
def rx_callback(device, buffer, buffer_length, valid_length):  # this callback function always needs to have these four args
    ...
    try:
        ...
        if callback_count == 2:
            ...
            print("Minimum:", raw.min())
            print("Maximum:", raw.max())
            print("Mean:", raw.mean())
            print("Standard deviation:", raw.std())
...
plt.savefig("iq_samples.png")

print("Saved waterfall.png and iq_samples.png")